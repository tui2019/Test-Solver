...
var genAI = new GoogleGenerativeAI("Your api Key");
...
async function get_answers(request, sender, sendResponse) {
  ...
  if(answers_str.length<=0){
    var prompt_str = "Допоможи вирішити завдання дай лаконічну, достатню відповідь на наступне запитання " + request.question;
